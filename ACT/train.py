...
parser.add_argument('--task', type=str, default='picknplaceEE_highres')
...
def train_bc(train_dataloader, val_dataloader, policy_config):
    ...
    for epoch in range(train_cfg['num_epochs']):
        ...
        for batch_idx, data in enumerate(train_dataloader):
            ...
            epoch_train_dicts.append(detach_dict(forward_dict))  # <-- add
        epoch_summary = compute_dict_mean(epoch_train_dicts)  # <-- replaces the slice
